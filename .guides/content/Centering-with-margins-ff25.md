We already previously saw a way to center text, it's `text-align:center;` but this will center a text inside its "box" .. We didn't see yet how to center a box inside its parent.
